...
import { Detenido_Save, Detenido_update, Detenidos, DetenidosDTO, DetenidosDTO_Net } from 'src/app/models/detenidos/detenidos';
...
export class DetenidosService {
  ...
  public insertDetenido(createDetenido : Detenido_Save): Observable<any> {
  ...
  public editarDetenido(id:string,formDetenido: Detenido_update) {
    const headers = new HttpHeaders({
      'Content-Type': 'application/json'
    });
